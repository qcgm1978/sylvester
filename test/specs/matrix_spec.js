JS.ENV.MatrixSpec = JS.Test.describe("Matrix", function () {
  with (this) {
    before(function () {
      with (this) {
    ...
    test('The sum of two matrices A ∈ Rm×n , B ∈ Rm×n is defined as the element- wise sum', function () {
      with (this) {
